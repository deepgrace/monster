...
// g++ -I include -m64 -std=c++20 -s -Wall -Os -fconcepts -o /tmp/monster example/monster.cpp
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "tuple_subranges " << std::get<1>(std::get<1>(tuple_slide<2>(tuple))) << std::endl;
